...
const relatedProducts = [
  { id: 10, name: "Clay Clean", price: "8,90 €", image: productsData[0].image },
  { id: 11, name: "Citrus Foam", price: "8,90 €", image: productsData[1].image },
  { id: 12, name: "Soft Drops", price: "6,90 €", image: productsData[2].image },
];
...
const ProductDetail = () => {
  ...
  const images = [product.image, productsData[2].image, productsData[1].image];
