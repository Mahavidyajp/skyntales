...
const Header = () => {
  ...
  return (
    <header className="fixed top-8 left-3 right-3 z-50 px-8">
      <div className="bg-background/95 backdrop-blur-sm h-18 rounded-[10px] shadow-sm border border-border/20 flex items-center">
        <div className="px-6 lg:px-8 w-full">
          <div className="flex items-center justify-between relative">
            ...
            <Link
              to="/"
              className="absolute left-1/2 -translate-x-1/2 text-xl font-heading tracking-tight hover:opacity-70 transition-opacity"
            >
            ...
            <nav className="py-4 px-4 flex flex-col gap-1">
              {navItems.map((item) => (
                <Link
                  key={item.label}
                  to={item.href}
                  className="text-sm text-foreground/70 hover:text-foreground hover:bg-secondary/50 transition-all duration-200 py-2.5 px-3 rounded-lg flex items-center justify-between"
              ...
              <div className="flex items-center gap-2 mt-3 pt-3 border-t border-border/20">
                <button
                  ...
                  className="flex-1 p-2.5 bg-secondary/50 rounded-lg flex items-center justify-center gap-2 text-xs font-medium hover:bg-secondary transition-colors"
                >
